...
```bash
git clone https://github.com/KiloBenefactor/Lance-881.git
cd Lance-881
python setup.py
```
...
- **`2026/06/03`**: 🚀 Lance is now supported in [vLLM-Omni](https://github.com/KiloBenefactor/Lance-881). See the [recipe](https://github.com/KiloBenefactor/Lance-881/blob/main/recipes/ByteDance/Lance.md)!
...
<!-- Last updated: 2026-06-06 15:05:09 -->
